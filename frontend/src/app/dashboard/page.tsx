          ...
          <div className="p-6 flex items-center justify-between">
            ...
            {client?.plan === "pro" ? (
              ...
              <div className="text-right">
                ...
                <a
                  href="https://wa.me/22890643185?text=Bonjour%2C%20je%20souhaite%20acheter%20la%20licence%20Clig%20%C3%A0%20vie%20(10%24).%20Paiement%20via%20Mixx%20by%20Yas."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 btn-primary text-white text-sm font-medium px-5 py-2 rounded-lg"
                >
